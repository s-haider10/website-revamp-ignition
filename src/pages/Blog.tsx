...
const Blog = () => {
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: "A comprehensive review of recent advances in quantum machine learning, including practical implementations and potential commercial applications.",
      date: "2023-11-20",
    ...
    },
    {
      ...
      excerpt: "Key principles for building technically excellent products that scale, drawn from experience with successful startups and research-to-product transitions.",
      date: "2023-10-15",
      readTime: "9 min read",
      category: "Startups",
