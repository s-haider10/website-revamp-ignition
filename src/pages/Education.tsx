                  ...
                  <div className="xl:w-1/3 p-6 sm:p-8 bg-muted/30">
                    <div className="flex items-center space-x-4 mb-6">
                      ...
                      <div className="min-w-0">
                        <h3 className="font-bold text-lg sm:text-xl text-foreground">{edu.institution}</h3>
                        <div className="flex items-center space-x-2 text-muted-foreground mt-1">
                          <MapPin className="h-3 w-3 sm:h-4 sm:w-4 flex-shrink-0" />
                          <span className="text-sm truncate">{edu.location}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-primary font-medium text-sm sm:text-base">{edu.degree}</p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm sm:text-base">{edu.period}</p>
                    ...
                    <div>
                      ...
                      <ul className="space-y-3">
                        {edu.highlights.map((highlight, highlightIndex) => (
                          <li key={highlightIndex} className="text-muted-foreground flex items-start leading-relaxed text-sm sm:text-base">
